...
function M.setup()
  ...
  -- ctags navigation (easy home row bindings)
  vim.keymap.set("n", "gd", "<C-]>", { desc = "Jump to tag under cursor" })
  vim.keymap.set("n", "gs", "g<C-]>", { desc = "Show tag list if multiple matches" })
  vim.keymap.set("n", "gb", "<C-t>", { desc = "Jump back to previous location" })
end
