...
_G.packer_plugins = {
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-ruby", "telescope-dap.nvim", "nvim-dap-go", "nvim-dap-python", "nvim-dap-virtual-text" },
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/mmc/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
